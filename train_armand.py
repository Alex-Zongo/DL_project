...
# from model.demucs_modified import AlexDemucs
from model.demucs_armand import ArmandDemucs
...
if __name__ == '__main__':
    ...
    model = ArmandDemucs(n_in=channels, channel_features=num_features, n_out=channels, target_output_size=target_outputs,
